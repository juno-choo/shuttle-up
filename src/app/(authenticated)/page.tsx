...
// This is the content previously in src/app/page.tsx
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Matches scheduled this week</p>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Your current rank in Group A</p>
             <Button asChild variant="link" className="px-0 pt-4">
              <Link href="/standings">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Teams competing in the league</p>
             <Button asChild variant="link" className="px-0 pt-4">
              <Link href="/teams">
      ...
      <div className="mt-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Stay updated with the latest league news.</CardDescription>
          </CardHeader>
          <CardContent>
