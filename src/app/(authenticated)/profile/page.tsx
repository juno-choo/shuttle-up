      ...
      <Card>
        <CardHeader className="flex flex-col items-center text-center border-b pb-6">
          <Avatar className="h-24 w-24 mb-4">
            ...
            {combinedProfile.avatar && <AvatarImage src={combinedProfile.avatar} alt={combinedProfile.name} />}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 <div className="space-y-1">
                   <Label htmlFor="name" className="flex items-center gap-1 text-muted-foreground"><User className="h-4 w-4" /> Name</Label>
                 ...
                 <div className="space-y-1">
                   <Label htmlFor="team" className="flex items-center gap-1 text-muted-foreground"><Users className="h-4 w-4" /> Team</Label>
                   <Input id="team" value={combinedProfile.team} readOnly />
                 </div>
                  <div className="space-y-1">
                   <Label htmlFor="skill" className="flex items-center gap-1 text-muted-foreground"><ShieldCheck className="h-4 w-4" /> Skill Level</Label>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{combinedProfile.matchesWon}</div>
                       <p className="text-xs text-muted-foreground">
                         {combinedProfile.matchesPlayed > 0 ? `${((combinedProfile.matchesWon / combinedProfile.matchesPlayed) * 100).toFixed(0)}% win rate` : 'N/A'}
                       </p>
                    </CardContent>
                  </Card>
              </div>
