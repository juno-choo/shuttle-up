...
export default function UmpirePage() {
  const [selectedMatchId, setSelectedMatchId] = useState<string | undefined>(
    undefined
  ); // Use undefined for initial state
  ...
  const selectedMatch = availableMatches.find(
  ...
  const handleGameEnd = (winner: "A" | "B") => {
    ...
    const winnerTeamName =
      winner === "A" ? selectedMatch.teamA : selectedMatch.teamB;
    resetScore();
    toast({
      title: `Game ${gameA + gameB + 1} ended`,
      description: `Winner: ${winnerTeamName}`,
    });
  ...
  const submitFinalScore = () => {
    ...
    if (gameA === 0 && gameB === 0) {
      toast({
        title: "Cannot Submit",
        description: "No games have been recorded.",
        variant: "destructive",
      });
      return;
    }
    ...
    <div className="container mx-auto py-8">
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Choose the match you are currently umpiring.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {selectedMatch && (
        <Card>
          <CardHeader>
            <CardTitle>
              Live Scoring: {selectedMatch.teamA} vs {selectedMatch.teamB}
            </CardTitle>
            <CardDescription>
              Court: {selectedMatch.court} | Games: {gameA} - {gameB}
            </CardDescription>
          </CardHeader>
              ...
              <div>
                ...
                <div className="flex justify-center gap-2">
                  <Button
                    ...
                    aria-label={`Decrease score for ${selectedMatch.teamA}`}
                  >
                  ...
                  <Button
                    ...
                    aria-label={`Increase score for ${selectedMatch.teamA}`}
                  >
                ...
                <Button
                  variant="outline"
                  className="mt-4"
                  onClick={() => handleGameEnd("A")}
                  disabled={
                    scoreA < 21 && scoreB < 21 /* Add win-by-2 logic later */
                  }
                >
              ...
              <div>
                ...
                <div className="flex justify-center gap-2">
                  <Button
                    ...
                    aria-label={`Decrease score for ${selectedMatch.teamB}`}
                  >
                    <Minus className="h-5 w-5" />
                  </Button>
                  <Button
                    ...
                    aria-label={`Increase score for ${selectedMatch.teamB}`}
                  >
                    <Plus className="h-5 w-5" />
                  </Button>
                </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-2 flex-wrap justify-center">
                ...
                <Button
                  ...
                  disabled={
                    gameA === 0 && gameB === 0 /* Add match completion logic */
                  }
                >
